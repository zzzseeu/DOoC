...
def test_MultiOmicsSmiReg(smi_tkz):
    ...
    model = models.MultiOmicsSmiReg()
    pipeline = pipelines.MultiOmicsSmiReg(smi_tokenizer=smi_tkz,
                   model=model)
...
def test_MultiOmicsSmisRank(smi_tkz):
    ...
    class Pointwise(pipelines._MultiOmicsSmi, pipelines._MultiOmicsSmisRank):
        pass
